window.addEventListener("DOMContentLoaded", () => {
  ...
  //Реализация карточек с помощью классов
  ...
  new MenuCard(
    ...
    "vegy",
    'Меню "Фитнес"',
    'Меню "Фитнес" - это новый подход к приготовлению блюд: большe свежих овощей и фруктов. Продукт активных и здоровых людей. Это aбсолютно новый продукт с оптимальной ценой и высоким качеством!',
    9,
    ".menu .container"
  ).render();
